...
current_capacity = next((item["Capacity"] for item in dorm_data if item["Dorm Name"] == selected_dorm), 0)

selected_dorm_id = next((item.get("dormId", i+1) for i, item in enumerate(dorm_data) if item["Dorm Name"] == selected_dorm), 1)
